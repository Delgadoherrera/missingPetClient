                ...
                <div className="data-item-content">
                    ...
                    <div>
                        ...
                        <div className="car-buttons mt-5">
                            <Button onClick={() => petFounded(data)} className="p-button p-button-rounded mr-2" label={`Encontre a ${data.nombre}`} />
                            {dialogFounded === true ? <ContactoMascotaEncontrada setDialog={contactPetFounded} idMascotaPerdida={data} /> : <p></p>}
                        </div>
                    </div>
                </div>
            </div>
